...
final myLeavesProvider = FutureProvider.autoDispose<List<Map<String, dynamic>>>((ref) async {
  return ref.watch(employeeRepositoryProvider).getMyLeaves();
});

final myPayrollProvider = FutureProvider.autoDispose<Map<String, dynamic>>((ref) async {
  return ref.watch(payrollRepositoryProvider).getMyPayroll();
});

final myTodayProvider = FutureProvider.autoDispose<Map<String, dynamic>>((ref) async {
  return ref.watch(attendanceRepositoryProvider).getMyToday();
});
